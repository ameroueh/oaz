...
template <class Game>
NNTrainer<Game>::NNTrainer(size_t batch_size, size_t epoch_size): 
...
template <class Game>
void NNTrainer<Game>::initialise() {
...
template <class Game>
void NNTrainer<Game>::load_model(std::string model_path) {
...
template <class Game>
void NNTrainer<Game>::checkpoint(std::string model_path) {
